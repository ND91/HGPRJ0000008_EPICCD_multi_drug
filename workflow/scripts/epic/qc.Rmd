...
rgset <- readRDS("/mnt/smb/lkgres/ayliyim/projects/PRJ0000008_EPICCD/multi_drug/output/epic/import/rgset.Rds")
```
...
```{r save data}
saveRDS(rgset_qc, file = "/mnt/smb/lkgres/ayliyim/projects/PRJ0000008_EPICCD/multi_drug/output/epic/qc/rgset_qc.Rds", compress = "gzip")
```
