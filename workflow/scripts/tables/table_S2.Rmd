...
```{r outpaths}
tablepath <- file.path(basepath, "output/tables/tableS2")
dir.create(tablepath)

table_predictorcpgs_t1_ust_csv <- file.path(tablepath, "table_predictorcpgs_t1_ust.csv")
```
...
## Table Predictor CpGs T1 UST

```{r table predictorcpgs t1 ust}
table_predictorcpgs_t1_ust <- dmps_ust %>%
  ...
  readr::write_csv(table_predictorcpgs_t1_ust_csv)
```
